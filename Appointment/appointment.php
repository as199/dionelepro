...
//echo $row1; 
$p_query=mysqli_query($db_connect,"SELECT * FROM patientregister")or die (mysqli_error());
...
{ //echo "string"; exit;
 ...
 // echo"Upload Complete";  
  ...
  $write =mysqli_query("INSERT INTO addfiles( `doc_date`,`patient`,`title`,`file`) VALUES (' $d1','$patient','$title','$name')") or die(mysqli_error($db_connect));
...
<div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
               <?php
   if (mysqli_num_rows($query) > 0) { //foreach ($row1 as $row)
